...
class TestDevEndpoints(unittest.TestCase):
    ...
    def test_health_endpoint_in_dev_mode(self) -> None:
    ...
    def test_health_endpoint_in_prod_mode(self) -> None:
    ...
    def test_users_endpoint_in_dev_mode(self) -> None:
    ...
    def test_users_endpoint_in_prod_mode(self) -> None:
