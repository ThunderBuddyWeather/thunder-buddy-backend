# PowerShell wrapper script for rebuild-dev.ps1
...
# The actual implementation resides in scripts/shell/rebuild-dev.ps1.
# 
...
& "$scriptDir\..\scripts\shell\rebuild-dev.ps1" @args 